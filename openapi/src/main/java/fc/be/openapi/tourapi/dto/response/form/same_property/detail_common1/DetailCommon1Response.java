package fc.be.openapi.tourapi.dto.response.form.same_property.detail_common1;
 ...
 */
public record DetailCommon1Response(Response<Item> response) implements TourAPIResponse {
    @Override
