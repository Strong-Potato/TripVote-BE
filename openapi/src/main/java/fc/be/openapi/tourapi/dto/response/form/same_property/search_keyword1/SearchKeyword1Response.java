package fc.be.openapi.tourapi.dto.response.form.same_property.search_keyword1;
 ...
 */
public record SearchKeyword1Response(Response<Item> response) implements TourAPIResponse {
    @Override
