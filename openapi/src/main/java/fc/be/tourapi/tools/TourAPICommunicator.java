...
import fc.be.tourapi.exception.TourAPIXMLErrorResponse;
import fc.be.tourapi.exception.WrongRequestException;
import fc.be.tourapi.exception.WrongXMLFormatException;
