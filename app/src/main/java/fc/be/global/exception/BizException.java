 ...
 * </h3>
 * <p>
 *     API 스펙을 충족시키지 못한 요청은 `ArgumentResolver` 가 동작하는 시점에 ValidationException 을 던지게 되고, 이를 ({@link org.springframework.web.servlet.mvc.method.annotation.ResponseEntityExceptionHandler} 를 상속하고 있는) {@link fc.be.global.exception.GlobalExceptionHandler} 가 받아 처리하게 됩니다.
 ...
 *     따라서 별도의 Exception({@link fc.be.global.exception.ExternalServiceException}) 에서 처리하도록 구현하였습니다.
 * </p>
 * <br>
 *
 * <h3>
 ...
 *
 * @author donghar
 * @see fc.be.global.exception.ExternalServiceException
 */
